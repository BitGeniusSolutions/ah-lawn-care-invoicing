...
- [`docs/PowerAutomate-Implementation.md`](docs/PowerAutomate-Implementation.md) — Build guide for the 5 flows: document numbering, totals recalculation, Estimate→Invoice conversion, optional PDF generation (view/download only, no email), and a delegation-safe "get all documents" flow used to cache data for the dashboard/list/search screens.
